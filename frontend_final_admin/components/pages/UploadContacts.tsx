...
import { uploadContacts, getGroupHierarchy } from '@/lib/api';
...
export default function UploadContacts() {
  ...
  const flattenGroups = (groups: Group[], prefix = ''): { id: string; label: string }[] => {
  ...
  const handleUpload = async () => {
    ...
    setUploading(true);
    try {
      await uploadContacts(selectedGroup, file);
      toast({
        title: "Success!",
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-2">
          Upload contacts with name and phone number, assigning them to subgroups
        </p>
      </div>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Select value={selectedGroup} onValueChange={setSelectedGroup}>
              <SelectTrigger>
                <SelectValue placeholder="Choose a group to upload contacts to" />
              </SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-blue-50 rounded-lg">
              <p className="text-sm text-blue-800">
                <strong>Note:</strong> Make sure to select the correct target group before uploading. 
                All contacts in the Excel file will be assigned to the selected group.
              </p>
            </div>
          </div>
        </CardContent>
